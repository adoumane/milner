...
\begin{itemize}
  ...
  \item \textbf{Case $e + f$.}
  %By induction, $e$ and $f$ are strongly complete, hence complete.
  Let $g, h_1$ and $h_2$ be regular expressions such that:
   \[h_1\prec e+f\quad \text{and}\quad h_2\prec e+f\quad \text{and}\quad h_1 g \sim h_2 g.\]
  We distinguish two cases.
\begin{itemize}
  \item $h_1\prec e$ and $h_2\prec e$. By induction hypothesis, $e$  is strongly complete, hence $h_1 g \equiv h_2 g$. 
  
  The same argument applies when $h_1\prec f$ and $h_2\prec f$.
  \item  $h_1 \prec e$ and $h_2 \prec f$. By Proposition~\ref{prop:sc-closure}(1), $h_1 h_1^*$ and $h_2 h_2^*$ are strongly complete.
  Since $e$ and $f$ are complete and $h_1, h_2$ are derivatives of distinct summands of $e+f$, the hypothesis $h_1 g \sim h_2 g$ implies $h_1 g \equiv h_2 g$.
\end{itemize}
  \item \textbf{Case $ef$.}
  %By induction, $e$ and $f$ are strongly complete, hence complete.
  Let $g, h_1$ and $h_2$ be regular expressions such that:
   \[h_1\prec ef\quad \text{and}\quad h_2\prec ef\quad \text{and}\quad h_1 g \sim h_2 g.\]
   \item \textbf{Case $e^*$.}
   %By induction, $e$ and $f$ are strongly complete, hence complete.
   Let $g, h_1$ and $h_2$ be regular expressions such that:
